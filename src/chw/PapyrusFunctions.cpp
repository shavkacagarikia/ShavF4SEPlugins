...
typedef BSTArray<TESObjectREFR*>(*_FindAllReferencesWithKeyword)(VirtualMachine* vm, UInt32 stackId, TESObjectREFR* target, TESForm* form, float val );
RelocAddr <_FindAllReferencesWithKeyword> FindAllReferencesWithKeywordInternal(0x1405B00);

BSTArray<TESObjectREFR*> FindAllReferencesWithKeyword(TESObjectREFR* target, TESForm* form, float val) {
